...
public class Actions {
    ...
    public static void SortFiles() {
        ...
        for (File mp3 : Info.getMp3()) {
            System.out.println(Info.getStatis());
            try {
...
//                            Info.setStatis(count);
                    ...
                    //JOptionPane.showMessageDialog(null, mp3.getName()+" May Have Custom Tags\n This Software Work With IDV2 Only","Oopss!!", JOptionPane.ERROR_MESSAGE);
        ...
        java.net.URL imgURL = GUI.class.getResource("Img/accept.png");
        ImageIcon icon = new ImageIcon(imgURL);
                    JLabel taskdoneMsg = new JLabel();
                    taskdoneMsg.setIcon(icon);
                    taskdoneMsg.setText("<html><body><h3 style = color:Black;>Task Completed</h3></body></html>");
